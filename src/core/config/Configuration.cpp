...
template<>
void Configuration::set_value<std::string>(std::string key, std::shared_ptr<std::string> value) {
    // TODO
    throw std::runtime_error("set string value is not implemented yet");
}

template<>
std::shared_ptr<std::string> Configuration::get_value<std::string>(std::string key) {
    // TODO
...
template<>
std::shared_ptr<int> Configuration::get_value<int>(std::string key) {
    if (m_conf_data.find(key) == m_conf_data.end()) {
        return nullptr;
    }
...
template<class T>
std::shared_ptr<StreamEdge<T>> Configuration::get_edge(std::string key){
    if (m_conf_data.find(key) != m_conf_data.end()) {
...
template std::shared_ptr<StreamEdge<std::string>> Configuration::get_edge<std::string>(std::string key);
template void Configuration::set_edge<std::string>(std::string key, std::shared_ptr<StreamEdge<std::string>> edge);

//------------------------------------------------------
// Stream operator factory configuration
//------------------------------------------------------
template <class IN, class OUT>
void Configuration::set_operator_factory(std::string key, 
...
template void Configuration::set_operator_factory<std::string, std::string>(std::string key, 
                                        std::shared_ptr<StreamOperatorFactory<std::string>> operator_factory);
