...
public:
    TaskInfo(
            ...
            const std::string& task_name_with_subtasks, 
            int index_of_subtask, 
            int number_of_parallel_subtasks):
            m_task_name(task_name), 
            m_task_name_with_subtasks(task_name_with_subtasks), 
            m_index_of_subtask(index_of_subtask),
    ...
    TaskInfo(
            ...
            TaskInfo(
                task_name, 
                task_name + " (" + std::to_string(index_of_subtask + 1) + "/" + std::to_string(number_of_parallel_subtasks) + ")", 
                index_of_subtask, 
