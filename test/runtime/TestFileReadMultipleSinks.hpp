...
public:
    void testWordCount( void ) {
        ...
        std::shared_ptr<StreamEdge<MyTuple>> edge_2 = std::make_shared<StreamEdge<MyTuple>>(node_2, node_5, rebalance_partitioner);
        ...
        std::shared_ptr<InputGateDeploymentDescriptor>* input_gates_5_0 = new std::shared_ptr<InputGateDeploymentDescriptor>[1];
        input_gates_5_0[0] = std::make_shared<InputGateDeploymentDescriptor>(0, new std::string{"file-read (1/1)-0"}, 1);
        std::shared_ptr<InputGateDeploymentDescriptor>* input_gates_5_1 = new std::shared_ptr<InputGateDeploymentDescriptor>[1];
        input_gates_5_1[0] = std::make_shared<InputGateDeploymentDescriptor>(1, new std::string{"file-read (1/1)-0"}, 1);
        std::shared_ptr<InputGateDeploymentDescriptor>* input_gates_5_2 = new std::shared_ptr<InputGateDeploymentDescriptor>[1];
        input_gates_5_2[0] = std::make_shared<InputGateDeploymentDescriptor>(2, new std::string{"file-read (1/1)-0"}, 1);
        ...
        std::shared_ptr<TaskDeploymentDescriptor> tdd_5_0 = std::make_shared<TaskDeploymentDescriptor>(job_information->get_job_id(),
                                                                                                    job_information,
                                                                                                    task_information_5,
                                                                                                    106, // execution id
                                                                                                    allocation_id_2, 
                                                                                                    ...
                                                                                                    input_gates_5_0 // input_gates
                                                                                                    ); 
        std::shared_ptr<TaskDeploymentDescriptor> tdd_5_1 = std::make_shared<TaskDeploymentDescriptor>(job_information->get_job_id(),
                                                                                                    job_information,
                                                                                                    task_information_5,
                                                                                                    107, // execution id
                                                                                                    allocation_id_2, 
                                                                                                    ...
                                                                                                    1,   // number_of_input_gates
                                                                                                    nullptr, // result_partitions
                                                                                                    input_gates_5_1 // input_gates
                                                                                                    );
        std::shared_ptr<TaskDeploymentDescriptor> tdd_5_2 = std::make_shared<TaskDeploymentDescriptor>(job_information->get_job_id(),
                                                                                                    job_information,
                                                                                                    task_information_5,
                                                                                                    108, // execution id
                                                                                                    allocation_id_2, 
        ...
        task_exeuctor->submit_task(tdd_5_0);
        task_exeuctor->submit_task(tdd_5_1);
        task_exeuctor->submit_task(tdd_5_2);
        ...
        task_exeuctor->start_task(107);
        task_exeuctor->start_task(108);
        ...
        task_exeuctor->cancel_task(107);
        task_exeuctor->cancel_task(108);
    }
};