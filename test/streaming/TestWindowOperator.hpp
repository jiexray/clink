...
public:
    void testWindowOperatorCreate( void ) {
        ...
        HeapKeyedStateBackend<int, TimeWindow, std::vector<int>, ListState<int>, InternalListState<int, TimeWindow, int>> heap_state_backend(
        ...
        heap_state_backend.register_state_creator(
            ...
            HeapListState<int, TimeWindow, int>::create<InternalListState<int, TimeWindow, int>>);
